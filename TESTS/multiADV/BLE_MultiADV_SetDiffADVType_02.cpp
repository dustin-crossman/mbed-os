...
void schedule_ble_events12(BLE::OnEventsToProcessCallbackContext *context);

void multi_adv_cb12(ble::vendor::cypress::hci_multi_adv_sub_opcode_t sub_opcode, uint8_t status);
...
class BatteryDemo12 : ble::Gap::EventHandler {
public:
    BatteryDemo12(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start() {
        ...
        _ble.init(this, &BatteryDemo12::on_init_complete);

        _event_queue.call_every(500, this, &BatteryDemo12::blink);
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _button.fall(Callback<void()>(this, &BatteryDemo12::button_pressed));
        _button.rise(Callback<void()>(this, &BatteryDemo12::button_released));
    ...
    void start_advertising() {
        ...
        /* Register callback */
        cy_multi.cy_register_multi_adv_cmd_complete_cb(&multi_adv_cb12);
        ...
        /* ADV Instance 2 */
		adv_param._adv_type = ble::advertising_type_t::NON_CONNECTABLE_UNDIRECTED;
...
void BLE_MultiADV_SetDiffADVType_02()
{
    ...
    ble.onEventsToProcess(schedule_ble_events12);

    BatteryDemo12 demo12(ble, event_queue);
    demo12.start();
