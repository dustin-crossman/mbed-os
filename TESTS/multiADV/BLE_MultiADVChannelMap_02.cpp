...
void schedule_ble_events11(BLE::OnEventsToProcessCallbackContext *context);

void multi_adv_cb11(ble::vendor::cypress::hci_multi_adv_sub_opcode_t sub_opcode, uint8_t status);
...
class BatteryDemo11 : ble::Gap::EventHandler {
public:
    BatteryDemo11(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start() {
        ...
        _ble.init(this, &BatteryDemo11::on_init_complete);

        _event_queue.call_every(500, this, &BatteryDemo11::blink);
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _button.fall(Callback<void()>(this, &BatteryDemo11::button_pressed));
        _button.rise(Callback<void()>(this, &BatteryDemo11::button_released));
    ...
    void start_advertising() {
        ...
        /* Register callback */
        cy_multi.cy_register_multi_adv_cmd_complete_cb(&multi_adv_cb11);
		...
		adv_param._channel_map	= ble::pal::advertising_channel_map_t::ADVERTISING_CHANNEL_38_AND_39;									
        ...
        /* ADV Instance 2 */
		//adv_param._channel_map = ble::pal::advertising_channel_map_t::ADVERTISING_CHANNEL_37;
...
void BLE_MultiADVChannelMap_02()
{
    ...
    ble.onEventsToProcess(schedule_ble_events11);

    BatteryDemo11 demo11(ble, event_queue);
    demo11.start();
