...
void schedule_ble_events2(BLE::OnEventsToProcessCallbackContext *context);

void multi_adv_cb2(ble::vendor::cypress::hci_multi_adv_sub_opcode_t sub_opcode, uint8_t status);
...
class BatteryDemo2 : ble::Gap::EventHandler {
public:
    BatteryDemo2(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start() {
        ...
        _ble.init(this, &BatteryDemo2::on_init_complete);

        _event_queue.call_every(500, this, &BatteryDemo2::blink);

        _event_queue.dispatch(50000);
    }
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _button.fall(Callback<void()>(this, &BatteryDemo2::button_pressed));
        _button.rise(Callback<void()>(this, &BatteryDemo2::button_released));
    ...
    void start_advertising() {
        ...
        /* Register callback */
        cy_multi.cy_register_multi_adv_cmd_complete_cb(&multi_adv_cb2);
...
void BLE_MultiADV_SetAdvType_03()
{
    ...
    ble.onEventsToProcess(schedule_ble_events2);

    BatteryDemo2 demo2(ble, event_queue);
    demo2.start();
