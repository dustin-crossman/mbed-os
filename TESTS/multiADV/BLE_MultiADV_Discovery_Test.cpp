...
void schedule_ble_events13(BLE::OnEventsToProcessCallbackContext *context);

void multi_adv_cb13(ble::vendor::cypress::hci_multi_adv_sub_opcode_t sub_opcode, uint8_t status);
...
class BatteryDemo13 : ble::Gap::EventHandler {
public:
    BatteryDemo13(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start() {
        ...
        _ble.init(this, &BatteryDemo13::on_init_complete);

        _event_queue.call_every(500, this, &BatteryDemo13::blink);
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _button.fall(Callback<void()>(this, &BatteryDemo13::button_pressed));
        _button.rise(Callback<void()>(this, &BatteryDemo13::button_released));
    ...
    void start_advertising() {
        ...
        /* Register callback */
        cy_multi.cy_register_multi_adv_cmd_complete_cb(&multi_adv_cb13);
...
void BLE_MultiADV_Discovery_Test()
{
    ...
    ble.onEventsToProcess(schedule_ble_events13);

    BatteryDemo13 demo13(ble, event_queue);
    demo13.start();
