...
void schedule_ble_events8(BLE::OnEventsToProcessCallbackContext *context);

void multi_adv_cb8(ble::vendor::cypress::hci_multi_adv_sub_opcode_t sub_opcode, uint8_t status);
...
class BatteryDemo8 : ble::Gap::EventHandler {
public:
    BatteryDemo8(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start() {
        ...
        _ble.init(this, &BatteryDemo8::on_init_complete);

        _event_queue.call_every(500, this, &BatteryDemo8::blink);

        _event_queue.dispatch(30000);
    }
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _button.fall(Callback<void()>(this, &BatteryDemo8::button_pressed));
        _button.rise(Callback<void()>(this, &BatteryDemo8::button_released));
    ...
    void start_advertising() {
        ...
        /* Register callback */
        cy_multi.cy_register_multi_adv_cmd_complete_cb(&multi_adv_cb8);
        ...
        adv_param._adv_int_min = ble::adv_interval_t(611);
        adv_param._adv_int_max = ble::adv_interval_t(611);
        ...
        adv_param._adv_int_min = ble::adv_interval_t(697);
        adv_param._adv_int_max = ble::adv_interval_t(697);
...
void BLE_CustomADVInterval()
{
    ...
    ble.onEventsToProcess(schedule_ble_events8);

    BatteryDemo8 demo8(ble, event_queue);
    demo8.start();
