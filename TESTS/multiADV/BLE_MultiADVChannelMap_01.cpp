...
void schedule_ble_events9(BLE::OnEventsToProcessCallbackContext *context);

void multi_adv_cb9(ble::vendor::cypress::hci_multi_adv_sub_opcode_t sub_opcode, uint8_t status);
...
class BatteryDemo9 : ble::Gap::EventHandler {
public:
    BatteryDemo9(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start() {
        ...
        _ble.init(this, &BatteryDemo9::on_init_complete);

        _event_queue.call_every(500, this, &BatteryDemo9::blink);
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _button.fall(Callback<void()>(this, &BatteryDemo9::button_pressed));
        _button.rise(Callback<void()>(this, &BatteryDemo9::button_released));
    ...
    void start_advertising() {
        ...
        /* Register callback */
        cy_multi.cy_register_multi_adv_cmd_complete_cb(&multi_adv_cb9);
...
void BLE_MultiADVChannelMap_01()
{
    ...
    ble.onEventsToProcess(schedule_ble_events9);

    BatteryDemo9 demo9(ble, event_queue);
    demo9.start();
