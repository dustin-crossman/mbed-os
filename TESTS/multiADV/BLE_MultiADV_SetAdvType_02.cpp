...
void schedule_ble_events1(BLE::OnEventsToProcessCallbackContext *context);

void multi_adv_cb1(ble::vendor::cypress::hci_multi_adv_sub_opcode_t sub_opcode, uint8_t status);
...
class BatteryDemo1 : ble::Gap::EventHandler {
public:
    BatteryDemo1(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start() {
        ...
        _ble.init(this, &BatteryDemo1::on_init_complete);

        _event_queue.call_every(500, this, &BatteryDemo1::blink);
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _button.fall(Callback<void()>(this, &BatteryDemo1::button_pressed));
        _button.rise(Callback<void()>(this, &BatteryDemo1::button_released));
    ...
    void start_advertising() {
        ...
        /* Register callback */
        cy_multi.cy_register_multi_adv_cmd_complete_cb(&multi_adv_cb1);

        /* ADV Instance 1 */
        /* Create advertising parameters */
        ble::vendor::cypress::cy_ble_multi_adv_params_t adv_param(ble::advertising_type_t::SCANNABLE_UNDIRECTED , 
...
void BLE_MultiADV_SetAdvType_02()
{
    ...
    ble.onEventsToProcess(schedule_ble_events1);

    BatteryDemo1 demo1(ble, event_queue);
    demo1.start();
