...
void schedule_ble_events10(BLE::OnEventsToProcessCallbackContext *context);

void multi_adv_cb10(ble::vendor::cypress::hci_multi_adv_sub_opcode_t sub_opcode, uint8_t status);
...
class BatteryDemo10 : ble::Gap::EventHandler {
public:
    BatteryDemo10(BLE &ble, events::EventQueue &event_queue) :
        _ble(ble),
    ...
    void start() {
        ...
        _ble.init(this, &BatteryDemo10::on_init_complete);

        _event_queue.call_every(500, this, &BatteryDemo10::blink);
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _button.fall(Callback<void()>(this, &BatteryDemo10::button_pressed));
        _button.rise(Callback<void()>(this, &BatteryDemo10::button_released));

        start_advertising();
		//wait_ms(60000);
		//printf("I am waiting now\n");
		// ble::vendor::cypress::CyMulti_adv  cy_multi;
		//cy_multi.cy_start_multi_advertisements(0,0);
		//printf("ADV data disabled successfully\n");
    }
    ...
    void start_advertising() {
        ...
        /* Register callback */
        cy_multi.cy_register_multi_adv_cmd_complete_cb(&multi_adv_cb10);
        ...
        wait_ms(1000);
		cy_multi.cy_start_multi_advertisements(0,1);
        /* ADV Instance 2 */
		...
		wait_ms(1000);
        cy_multi.cy_start_multi_advertisements(0,2);
        /* ADV Instance 3 */
		...
		wait_ms(1000);
        cy_multi.cy_start_multi_advertisements(0,3);
    }
...
void BLE_DisableMultiADV_Test()
{
    ...
    ble.onEventsToProcess(schedule_ble_events10);

    BatteryDemo10 demo10(ble, event_queue);
    demo10.start();
