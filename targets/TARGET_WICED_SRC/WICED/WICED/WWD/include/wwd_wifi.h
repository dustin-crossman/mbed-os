...
*/
extern void wwd_wifi_link_update( wiced_bool_t );
 ...
 * @return     WWD_SUCCESS or Error code
 */
extern wwd_result_t wwd_join_mesh( const wiced_ssid_t* ssid, wwd_interface_t interface );
