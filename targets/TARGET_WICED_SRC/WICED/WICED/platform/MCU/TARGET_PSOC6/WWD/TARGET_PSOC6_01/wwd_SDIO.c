...
WWD_RTOS_MAP_ISR(SD_IRQ, udb_interrupts_0_IRQHandler)
WWD_RTOS_MAP_ISR(READ_DMA_IRQ, cpuss_interrupts_dw1_3_IRQHandler)
WWD_RTOS_MAP_ISR(WRITE_DMA_IRQ, cpuss_interrupts_dw1_1_IRQHandler)
