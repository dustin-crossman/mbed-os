 ...
 *
 * @usage:
 * PLATFORM_DEFINE_ISR( my_IRQHandler )
 * {
 *     // Do something here
 * }
 *
 ...
 *
 * @usage:
 * PLATFORM_MAP_ISR( my_IRQHandler, USART1_IRQHandler )
 */
#if defined( __GNUC__ )
 ...
 *
 * @usage:
 * PLATFORM_SET_DEFAULT_ISR( USART1_IRQHandler, default_handler )
 */
#if defined( __GNUC__ )
...
#define WICED_RESTORE_INTERRUPTS(flags) \
    do { __set_PRIMASK(flags); } while(0)
