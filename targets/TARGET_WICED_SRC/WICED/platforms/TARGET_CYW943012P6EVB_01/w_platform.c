...
/** @file
 * Defines board support package for CYW943012P6EVB_01 board
 */
...
const platform_gpio_t platform_gpio_pins[] =
{
    ...
    [WICED_GPIO_19] = { .port_num = 2,  .pin_num = (6U), .hsiom = P2_6_GPIO}, /* WWD_PIN_POWER - WL_REG_ON */
...
#else
    [WICED_GPIO_29] = { .port_num = 5,  .pin_num = (0U), .hsiom = P5_0_GPIO},
    [WICED_GPIO_30] = { .port_num = 5,  .pin_num = (1U), .hsiom = P5_1_GPIO},
    ...
    [WICED_GPIO_93] = { .port_num = 13, .pin_num = (0U), .hsiom = P13_0_SCB6_UART_RX},
    [WICED_GPIO_94] = { .port_num = 13, .pin_num = (1U), .hsiom = P13_1_SCB6_UART_TX},
...
const platform_pwm_t platform_pwm_peripherals[] =
{
    ...
    [WICED_PWM_3]  = PLATFORM_PWM(1, 2, WICED_GPIO_75, 10, 6),
    [WICED_PWM_4]  =
    {
        .block     = 0,
        .cntnum    = 0,
...
const platform_uart_t platform_uart_peripherals[] =
{
    ...
    [WICED_UART_7] =
    {
        .port    = 6,
        .scb     = &platform_scb6,
        .rx_pin  = &platform_gpio_pins[WICED_GPIO_93], /* UART RX pin */
        .tx_pin  = &platform_gpio_pins[WICED_GPIO_94], /* UART TX pin */
        .cts_pin = NULL, /* UART CTS pin */
        .rts_pin = NULL, /* UART RTS pin */
    },
    [WICED_UART_8] =
