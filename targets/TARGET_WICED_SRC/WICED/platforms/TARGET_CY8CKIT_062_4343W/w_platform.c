...
/** @file
 * Defines board support package for CY8CKIT_062_4343W board
 */
...
const platform_gpio_t platform_gpio_pins[] =
{
    ...
    [WICED_GPIO_73] = { .port_num = 10, .pin_num = (4U), .hsiom = P10_4_GPIO},
    [WICED_GPIO_74] = { .port_num = 10, .pin_num = (5U), .hsiom = P10_5_GPIO},
