...
const platform_gpio_t platform_gpio_pins[] =
{
    ...
    [WICED_GPIO_73] = { .port_num = 10, .pin_num = (4U), .hsiom = P10_4_AUDIOSS0_PDM_CLK},
    [WICED_GPIO_74] = { .port_num = 10, .pin_num = (5U), .hsiom = P10_5_AUDIOSS0_PDM_DATA},
...
{
    [PLATFORM_BUTTON_1] = { WICED_GPIO_5 },
};
...
void platform_init_peripheral_irq_priorities( void )
{
    ...
    NVIC_SetPriority( sdhc_0_interrupt_general_IRQn, 3 );       /* WLAN SDIO */
...
WWD_RTOS_MAP_ISR( mlg_platform_smif_irq , smif_interrupt_IRQHandler )
#endif
