...
ALIGNED_PRE(32) static const char wifi_nvram_image[] ALIGNED(32) =
       ...
       "macaddr=00:90:4c:2a:a${maclo12}"                                    "\x00"
       "mac_clkgating=1"                                                    "\x00"
       ...
       "#paprdis=1"                                                         "\x00"
       "#ofdmfilttype_2gbe=2"                                               "\x00"
       "bcntrim=9"                                                          "\x00"
       ""                                                                   "\x00"
       "# RSSI correction in qdB"                                           "\x00"
       "rssicorrnorm5g_c0=-10,-10,-10,-10,-10,-10,-10,-10,-10,-10,-10,-10"                                            "\x00"

       "# LHL pins to be left unchanged, 0 will change pins to input_disable, 1 will leave pin config unchanged. first uint32 is for lower 32 pins, second uint32 is for pins 32-39"                                            "\x00"
