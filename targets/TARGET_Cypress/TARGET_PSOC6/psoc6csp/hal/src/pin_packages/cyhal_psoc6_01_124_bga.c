...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_clk[16] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_miso[17] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_mosi[17] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select0[16] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select1[13] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select2[13] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select3[10] = {
