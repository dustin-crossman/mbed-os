/***************************************************************************//**
* \file cy_hal_psoc6_02_100_wlcsp.c
*
* \brief
...
static const cy_resource_inst_t CY_I2S_1 = { CY_RSC_I2S, 1, 0 };
...
static const cy_resource_inst_t CY_SCB_10 = { CY_RSC_SCB, 10, 0 };
static const cy_resource_inst_t CY_SCB_11 = { CY_RSC_SCB, 11, 0 };
static const cy_resource_inst_t CY_SCB_12 = { CY_RSC_SCB, 12, 0 };
...
static const cy_resource_inst_t CY_SCB_9 = { CY_RSC_SCB, 9, 0 };
static const cy_resource_inst_t CY_SDHC_0 = { CY_RSC_SDHC, 0, 0 };
static const cy_resource_inst_t CY_SDHC_1 = { CY_RSC_SDHC, 1, 0 };
...
const cy_resource_pin_mapping_t cy_pin_map_audioss_clk_i2s_if[4] = {
    {P5_0, &CY_I2S_0, CY_PIN_IN_FUNCTION(P5_0_AUDIOSS0_CLK_I2S_IF)},
    {P9_0, &CY_I2S_0, CY_PIN_IN_FUNCTION(P9_0_AUDIOSS0_CLK_I2S_IF)},
    {P11_0, &CY_I2S_1, CY_PIN_IN_FUNCTION(P11_0_AUDIOSS1_CLK_I2S_IF)},
    {P13_0, &CY_I2S_1, CY_PIN_IN_FUNCTION(P13_0_AUDIOSS1_CLK_I2S_IF)},
};

/* Connections for: audioss_pdm_clk */
const cy_resource_pin_mapping_t cy_pin_map_audioss_pdm_clk[2] = {
    {P10_4, &CY_PDM_0, CY_PIN_OUT_FUNCTION(P10_4_AUDIOSS0_PDM_CLK)},
    {P12_4, &CY_PDM_0, CY_PIN_OUT_FUNCTION(P12_4_AUDIOSS0_PDM_CLK)},
};

/* Connections for: audioss_pdm_data */
const cy_resource_pin_mapping_t cy_pin_map_audioss_pdm_data[2] = {
    {P10_5, &CY_PDM_0, CY_PIN_IN_FUNCTION(P10_5_AUDIOSS0_PDM_DATA)},
    {P12_5, &CY_PDM_0, CY_PIN_IN_FUNCTION(P12_5_AUDIOSS0_PDM_DATA)},
};

/* Connections for: audioss_rx_sck */
const cy_resource_pin_mapping_t cy_pin_map_audioss_rx_sck[4] = {
    {P5_4, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P5_4_AUDIOSS0_RX_SCK)},
    {P9_4, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P9_4_AUDIOSS0_RX_SCK)},
    {P11_4, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P11_4_AUDIOSS1_RX_SCK)},
    {P13_4, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P13_4_AUDIOSS1_RX_SCK)},
};

/* Connections for: audioss_rx_sdi */
const cy_resource_pin_mapping_t cy_pin_map_audioss_rx_sdi[3] = {
    {P5_6, &CY_I2S_0, CY_PIN_IN_FUNCTION(P5_6_AUDIOSS0_RX_SDI)},
    {P11_6, &CY_I2S_1, CY_PIN_IN_FUNCTION(P11_6_AUDIOSS1_RX_SDI)},
    {P13_6, &CY_I2S_1, CY_PIN_IN_FUNCTION(P13_6_AUDIOSS1_RX_SDI)},
};

/* Connections for: audioss_rx_ws */
const cy_resource_pin_mapping_t cy_pin_map_audioss_rx_ws[3] = {
    {P5_5, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P5_5_AUDIOSS0_RX_WS)},
    {P11_5, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P11_5_AUDIOSS1_RX_WS)},
    {P13_5, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P13_5_AUDIOSS1_RX_WS)},
};

/* Connections for: audioss_tx_sck */
const cy_resource_pin_mapping_t cy_pin_map_audioss_tx_sck[4] = {
    {P5_1, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P5_1_AUDIOSS0_TX_SCK)},
    {P9_1, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P9_1_AUDIOSS0_TX_SCK)},
    {P11_1, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P11_1_AUDIOSS1_TX_SCK)},
    {P13_1, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P13_1_AUDIOSS1_TX_SCK)},
};

/* Connections for: audioss_tx_sdo */
const cy_resource_pin_mapping_t cy_pin_map_audioss_tx_sdo[4] = {
    {P5_3, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P5_3_AUDIOSS0_TX_SDO)},
    {P9_3, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P9_3_AUDIOSS0_TX_SDO)},
    {P11_3, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P11_3_AUDIOSS1_TX_SDO)},
    {P13_3, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P13_3_AUDIOSS1_TX_SDO)},
};

/* Connections for: audioss_tx_ws */
const cy_resource_pin_mapping_t cy_pin_map_audioss_tx_ws[4] = {
    {P5_2, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P5_2_AUDIOSS0_TX_WS)},
    {P9_2, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P9_2_AUDIOSS0_TX_WS)},
    {P11_2, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P11_2_AUDIOSS1_TX_WS)},
    {P13_2, &CY_I2S_1, CY_PIN_OUT_FUNCTION(P13_2_AUDIOSS1_TX_WS)},
};
...
const cy_resource_pin_mapping_t cy_pin_map_scb_i2c_scl[19] = {
    ...
    {P2_4, &CY_SCB_9, CY_PIN_OD_FUNCTION(P2_4_SCB9_I2C_SCL)},
    {P5_0, &CY_SCB_5, CY_PIN_OD_FUNCTION(P5_0_SCB5_I2C_SCL)},
    {P5_4, &CY_SCB_10, CY_PIN_OD_FUNCTION(P5_4_SCB10_I2C_SCL)},
    ...
    {P8_4, &CY_SCB_11, CY_PIN_OD_FUNCTION(P8_4_SCB11_I2C_SCL)},
    ...
    {P13_4, &CY_SCB_12, CY_PIN_OD_FUNCTION(P13_4_SCB12_I2C_SCL)},
};

/* Connections for: scb_i2c_sda */
const cy_resource_pin_mapping_t cy_pin_map_scb_i2c_sda[18] = {
    ...
    {P2_5, &CY_SCB_9, CY_PIN_OD_FUNCTION(P2_5_SCB9_I2C_SDA)},
    {P5_1, &CY_SCB_5, CY_PIN_OD_FUNCTION(P5_1_SCB5_I2C_SDA)},
    {P5_5, &CY_SCB_10, CY_PIN_OD_FUNCTION(P5_5_SCB10_I2C_SDA)},
    ...
    {P13_5, &CY_SCB_12, CY_PIN_OD_FUNCTION(P13_5_SCB12_I2C_SDA)},
};
...
const cy_resource_pin_mapping_t cy_pin_map_scb_spi_miso[15] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_spi_mosi[15] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_spi_select2[8] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_spi_select3[7] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_cts[15] = {
    {P0_5, &CY_SCB_0, CY_PIN_IN_FUNCTION(P0_5_SCB0_UART_CTS)},
    {P2_3, &CY_SCB_1, CY_PIN_IN_FUNCTION(P2_3_SCB1_UART_CTS)},
    {P2_7, &CY_SCB_9, CY_PIN_IN_FUNCTION(P2_7_SCB9_UART_CTS)},
    {P5_3, &CY_SCB_5, CY_PIN_IN_FUNCTION(P5_3_SCB5_UART_CTS)},
    {P5_7, &CY_SCB_10, CY_PIN_IN_FUNCTION(P5_7_SCB10_UART_CTS)},
    ...
    {P13_7, &CY_SCB_12, CY_PIN_IN_FUNCTION(P13_7_SCB12_UART_CTS)},
};

/* Connections for: scb_uart_rts */
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rts[15] = {
    {P0_4, &CY_SCB_0, CY_PIN_OUT_FUNCTION(P0_4_SCB0_UART_RTS)},
    {P2_2, &CY_SCB_1, CY_PIN_OUT_FUNCTION(P2_2_SCB1_UART_RTS)},
    {P2_6, &CY_SCB_9, CY_PIN_OUT_FUNCTION(P2_6_SCB9_UART_RTS)},
    {P5_2, &CY_SCB_5, CY_PIN_OUT_FUNCTION(P5_2_SCB5_UART_RTS)},
    {P5_6, &CY_SCB_10, CY_PIN_OUT_FUNCTION(P5_6_SCB10_UART_RTS)},
    ...
    {P13_6, &CY_SCB_12, CY_PIN_OUT_FUNCTION(P13_6_SCB12_UART_RTS)},
};

/* Connections for: scb_uart_rx */
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rx[17] = {
    ...
    {P2_4, &CY_SCB_9, CY_PIN_IN_FUNCTION(P2_4_SCB9_UART_RX)},
    {P5_0, &CY_SCB_5, CY_PIN_IN_FUNCTION(P5_0_SCB5_UART_RX)},
    {P5_4, &CY_SCB_10, CY_PIN_IN_FUNCTION(P5_4_SCB10_UART_RX)},
    ...
    {P8_4, &CY_SCB_11, CY_PIN_IN_FUNCTION(P8_4_SCB11_UART_RX)},
    ...
    {P13_4, &CY_SCB_12, CY_PIN_IN_FUNCTION(P13_4_SCB12_UART_RX)},
};

/* Connections for: scb_uart_tx */
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_tx[16] = {
    ...
    {P2_5, &CY_SCB_9, CY_PIN_OUT_FUNCTION(P2_5_SCB9_UART_TX)},
    {P5_1, &CY_SCB_5, CY_PIN_OUT_FUNCTION(P5_1_SCB5_UART_TX)},
    {P5_5, &CY_SCB_10, CY_PIN_OUT_FUNCTION(P5_5_SCB10_UART_TX)},
    ...
    {P13_5, &CY_SCB_12, CY_PIN_OUT_FUNCTION(P13_5_SCB12_UART_TX)},
};

/* Connections for: sdhc_card_cmd */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_cmd[2] = {
    {P2_4, &CY_SDHC_0, CY_PIN_OUT_BUF_FUNCTION(P2_4_SDHC0_CARD_CMD)},
    {P12_4, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P12_4_SDHC1_CARD_CMD)},
};

/* Connections for: sdhc_card_dat_3to0 */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_dat_3to0[8] = {
    ...
    {P13_0, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P13_0_SDHC1_CARD_DAT_3TO00)},
    {P13_1, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P13_1_SDHC1_CARD_DAT_3TO01)},
    {P13_2, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P13_2_SDHC1_CARD_DAT_3TO02)},
    {P13_3, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P13_3_SDHC1_CARD_DAT_3TO03)},
};

/* Connections for: sdhc_card_dat_7to4 */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_dat_7to4[4] = {
    {P13_4, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P13_4_SDHC1_CARD_DAT_7TO40)},
    {P13_5, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P13_5_SDHC1_CARD_DAT_7TO41)},
    {P13_6, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P13_6_SDHC1_CARD_DAT_7TO42)},
    {P13_7, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P13_7_SDHC1_CARD_DAT_7TO43)},
};

/* Connections for: sdhc_card_detect_n */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_detect_n[2] = {
    {P2_6, &CY_SDHC_0, CY_PIN_IN_FUNCTION(P2_6_SDHC0_CARD_DETECT_N)},
    {P12_1, &CY_SDHC_1, CY_PIN_IN_FUNCTION(P12_1_SDHC1_CARD_DETECT_N)},
};

/* Connections for: sdhc_card_emmc_reset_n */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_emmc_reset_n[1] = {
    {P12_0, &CY_SDHC_1, CY_PIN_OUT_FUNCTION(P12_0_SDHC1_CARD_EMMC_RESET_N)},
};

/* Connections for: sdhc_card_if_pwr_en */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_if_pwr_en[1] = {
    {P12_6, &CY_SDHC_1, CY_PIN_OUT_FUNCTION(P12_6_SDHC1_CARD_IF_PWR_EN)},
};

/* Connections for: sdhc_card_mech_write_prot */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_mech_write_prot[2] = {
    {P2_7, &CY_SDHC_0, CY_PIN_IN_FUNCTION(P2_7_SDHC0_CARD_MECH_WRITE_PROT)},
    {P12_2, &CY_SDHC_1, CY_PIN_IN_FUNCTION(P12_2_SDHC1_CARD_MECH_WRITE_PROT)},
};

/* Connections for: sdhc_clk_card */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_clk_card[2] = {
    {P2_5, &CY_SDHC_0, CY_PIN_OUT_BUF_FUNCTION(P2_5_SDHC0_CLK_CARD)},
    {P12_5, &CY_SDHC_1, CY_PIN_OUT_BUF_FUNCTION(P12_5_SDHC1_CLK_CARD)},
};

/* Connections for: sdhc_io_volt_sel */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_io_volt_sel[1] = {
    {P12_7, &CY_SDHC_1, CY_PIN_OUT_FUNCTION(P12_7_SDHC1_IO_VOLT_SEL)},
};

/* Connections for: sdhc_led_ctrl */
const cy_resource_pin_mapping_t cy_pin_map_sdhc_led_ctrl[1] = {
    {P12_3, &CY_SDHC_1, CY_PIN_OUT_FUNCTION(P12_3_SDHC1_LED_CTRL)},
};
...
const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line[80] = {
...
const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line_compl[80] = {
