/***************************************************************************//**
* \file cy_hal_psoc6_02_128_tqfp.c
*
* \brief
...
const cy_resource_pin_mapping_t cy_pin_map_audioss_rx_sdi[4] = {
    {P5_6, &CY_I2S_0, CY_PIN_IN_FUNCTION(P5_6_AUDIOSS0_RX_SDI)},
    {P9_6, &CY_I2S_0, CY_PIN_IN_FUNCTION(P9_6_AUDIOSS0_RX_SDI)},
...
const cy_resource_pin_mapping_t cy_pin_map_audioss_rx_ws[4] = {
    {P5_5, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P5_5_AUDIOSS0_RX_WS)},
    {P9_5, &CY_I2S_0, CY_PIN_OUT_FUNCTION(P9_5_AUDIOSS0_RX_WS)},
...
const cy_resource_pin_mapping_t cy_pin_map_scb_i2c_scl[21] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_i2c_sda[21] = {
    ...
    {P8_5, &CY_SCB_11, CY_PIN_OD_FUNCTION(P8_5_SCB11_I2C_SDA)},
...
const cy_resource_pin_mapping_t cy_pin_map_scb_spi_clk[17] = {
    ...
    {P4_2, &CY_SCB_7, CY_PIN_OUT_FUNCTION(P4_2_SCB7_SPI_CLK)},
...
const cy_resource_pin_mapping_t cy_pin_map_scb_spi_select0[17] = {
    ...
    {P4_3, &CY_SCB_7, CY_PIN_OUT_FUNCTION(P4_3_SCB7_SPI_SELECT0)},
...
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_cts[19] = {
    ...
    {P4_3, &CY_SCB_7, CY_PIN_IN_FUNCTION(P4_3_SCB7_UART_CTS)},
    ...
    {P8_7, &CY_SCB_11, CY_PIN_IN_FUNCTION(P8_7_SCB11_UART_CTS)},
...
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rts[19] = {
    ...
    {P4_2, &CY_SCB_7, CY_PIN_OUT_FUNCTION(P4_2_SCB7_UART_RTS)},
    ...
    {P8_6, &CY_SCB_11, CY_PIN_OUT_FUNCTION(P8_6_SCB11_UART_RTS)},
...
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rx[19] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_tx[19] = {
    ...
    {P8_5, &CY_SCB_11, CY_PIN_OUT_FUNCTION(P8_5_SCB11_UART_TX)},
...
const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line[100] = {
    ...
    {P4_2, &CY_TCPWM_0_6, CY_PIN_OUT_FUNCTION(P4_2_TCPWM0_LINE6)},
    {P4_2, &CY_TCPWM_1_23, CY_PIN_OUT_FUNCTION(P4_2_TCPWM1_LINE23)},
...
const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line_compl[100] = {
    ...
    {P4_3, &CY_TCPWM_0_6, CY_PIN_OUT_FUNCTION(P4_3_TCPWM0_LINE_COMPL6)},
    {P4_3, &CY_TCPWM_1_23, CY_PIN_OUT_FUNCTION(P4_3_TCPWM1_LINE_COMPL23)},
