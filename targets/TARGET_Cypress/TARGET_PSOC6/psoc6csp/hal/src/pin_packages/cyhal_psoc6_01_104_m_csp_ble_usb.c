...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_clk[12] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select0[12] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select3[6] = {
