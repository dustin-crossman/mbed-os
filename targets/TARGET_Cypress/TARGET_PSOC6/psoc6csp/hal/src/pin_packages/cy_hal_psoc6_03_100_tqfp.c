/***************************************************************************//**
* \file cy_hal_psoc6_03_100_tqfp.c
*
* \brief
...
const cy_resource_pin_mapping_t cy_pin_map_scb_spi_select0[9] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_spi_select2[5] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_cts[8] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rts[8] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rx[10] = {
...
const cy_resource_pin_mapping_t cy_pin_map_scb_uart_tx[10] = {
...
const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line[64] = {
    ...
    {P7_6, &CY_TCPWM_0_1, CY_PIN_OUT_FUNCTION(P7_6_TCPWM0_LINE1)},
    {P7_6, &CY_TCPWM_1_1, CY_PIN_OUT_FUNCTION(P7_6_TCPWM1_LINE1)},
    {P8_0, &CY_TCPWM_0_2, CY_PIN_OUT_FUNCTION(P8_0_TCPWM0_LINE2)},
    {P8_0, &CY_TCPWM_1_2, CY_PIN_OUT_FUNCTION(P8_0_TCPWM1_LINE2)},
    {P8_2, &CY_TCPWM_0_3, CY_PIN_OUT_FUNCTION(P8_2_TCPWM0_LINE3)},
    {P8_2, &CY_TCPWM_1_3, CY_PIN_OUT_FUNCTION(P8_2_TCPWM1_LINE3)},
    ...
    {P12_0, &CY_TCPWM_0_2, CY_PIN_OUT_FUNCTION(P12_0_TCPWM0_LINE2)},
    {P12_0, &CY_TCPWM_1_6, CY_PIN_OUT_FUNCTION(P12_0_TCPWM1_LINE6)},
...
const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line_compl[64] = {
    ...
    {P7_5, &CY_TCPWM_0_0, CY_PIN_OUT_FUNCTION(P7_5_TCPWM0_LINE_COMPL0)},
    {P7_5, &CY_TCPWM_1_0, CY_PIN_OUT_FUNCTION(P7_5_TCPWM1_LINE_COMPL0)},
    ...
    {P8_3, &CY_TCPWM_0_3, CY_PIN_OUT_FUNCTION(P8_3_TCPWM0_LINE_COMPL3)},
    {P8_3, &CY_TCPWM_1_3, CY_PIN_OUT_FUNCTION(P8_3_TCPWM1_LINE_COMPL3)},
    ...
    {P10_7, &CY_TCPWM_1_1, CY_PIN_OUT_FUNCTION(P10_7_TCPWM1_LINE_COMPL1)},
    ...
    {P12_1, &CY_TCPWM_0_2, CY_PIN_OUT_FUNCTION(P12_1_TCPWM0_LINE_COMPL2)},
    {P12_1, &CY_TCPWM_1_6, CY_PIN_OUT_FUNCTION(P12_1_TCPWM1_LINE_COMPL6)},
