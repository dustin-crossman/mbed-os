/***************************************************************************//**
* \file cy_hal_psoc6_01_124_bga.h
*
* \brief
...
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_act_bpktctl[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_act_dbus_rx_en[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_act_dbus_tx_en[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_act_txd_rxd[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_act_ldo_en[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_buck_en[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_clk_en[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_dig_ldo_en[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_isolate_n[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_rcb_clk[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_rcb_data[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_rcb_le[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_reset_n[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_ret_ldo_ol_hv[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_ret_switch_hv[1];
extern const cy_resource_pin_mapping_t cy_pin_map_bless_mxd_dpslp_xtal_en[1];
...
extern const cy_resource_pin_mapping_t cy_pin_map_scb_i2c_scl[17];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_i2c_sda[17];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_spi_clk[16];
...
extern const cy_resource_pin_mapping_t cy_pin_map_scb_spi_select0[16];
...
extern const cy_resource_pin_mapping_t cy_pin_map_scb_uart_cts[14];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rts[14];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rx[15];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_uart_tx[15];
...
extern const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line[98];
extern const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line_compl[98];
