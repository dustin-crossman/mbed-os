...
#ifndef _CY_HAL_PSOC6_02_68_QFN_H_
#define _CY_HAL_PSOC6_02_68_QFN_H_
...
/* Pin connections */
extern const cy_resource_pin_mapping_t cy_pin_map_audioss_clk_i2s_if[3];
...
extern const cy_resource_pin_mapping_t cy_pin_map_audioss_rx_sdi[2];
extern const cy_resource_pin_mapping_t cy_pin_map_audioss_rx_ws[1];
extern const cy_resource_pin_mapping_t cy_pin_map_audioss_tx_sck[3];
extern const cy_resource_pin_mapping_t cy_pin_map_audioss_tx_sdo[2];
extern const cy_resource_pin_mapping_t cy_pin_map_audioss_tx_ws[2];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_i2c_scl[12];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_i2c_sda[12];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_spi_clk[10];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_spi_miso[11];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_spi_mosi[11];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_spi_select0[10];
...
extern const cy_resource_pin_mapping_t cy_pin_map_scb_spi_select3[5];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_uart_cts[10];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rts[10];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_uart_rx[11];
extern const cy_resource_pin_mapping_t cy_pin_map_scb_uart_tx[11];
extern const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_cmd[1];
extern const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_dat_3to0[4];
extern const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_detect_n[1];
extern const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_if_pwr_en[2];
extern const cy_resource_pin_mapping_t cy_pin_map_sdhc_card_mech_write_prot[1];
extern const cy_resource_pin_mapping_t cy_pin_map_sdhc_clk_card[1];
...
extern const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line[50];
extern const cy_resource_pin_mapping_t cy_pin_map_tcpwm_line_compl[52];

#if defined(__cplusplus)
}
#endif /* __cplusplus */

#endif /* _CY_HAL_PSOC6_02_68_QFN_H_ */
