...
/**
* \addtogroup group_bsp_abstraction
* \{
* These are APIs that are common to multiple boards. All boards that support a
* specific capability (eg: RetargetIO) will support all the functions exactly as
* described. However, not all boards will support all capabilities. For example, 
* WiFi APIs are only available on boards that acutally have a WiFi chip on them.
* \} group_bsp_abstraction
*/

/**
* \addtogroup group_bsp_board Core
...
* hardware found on the board.
*
* \defgroup group_bsp_board_macros Macros
* \defgroup group_bsp_board_functions Functions
*/
...
/**
* \addtogroup group_bsp_board_macros
* \{
*/
...
/**
* \addtogroup group_bsp_board_functions
* \{
*/
