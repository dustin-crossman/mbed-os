...
#define CYBSP_BT_POWER_PORT GPIO_PRT0
#define CYBSP_BT_POWER_PORT_NUM 0U
...
#endif
#define CYBSP_BT_POWER_HSIOM ioss_0_port_0_pin_2_HSIOM
#define CYBSP_BT_POWER_IRQ ioss_interrupts_gpio_0_IRQn
#if defined (CY_USING_HAL)
	#define CYBSP_BT_POWER_HAL_PORT_PIN P0_2
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#define CYBSP_BT_HOST_WAKE_PORT GPIO_PRT0
#define CYBSP_BT_HOST_WAKE_PORT_NUM 0U
...
#endif
#define CYBSP_BT_HOST_WAKE_HSIOM ioss_0_port_0_pin_5_HSIOM
#define CYBSP_BT_HOST_WAKE_IRQ ioss_interrupts_gpio_0_IRQn
#if defined (CY_USING_HAL)
	#define CYBSP_BT_HOST_WAKE_HAL_PORT_PIN P0_5
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#define CYBSP_EZI2C_SDA_PIN 5U
#define CYBSP_EZI2C_SDA_NUM 5U
...
#endif
#define CYBSP_EZI2C_SDA_HSIOM ioss_0_port_6_pin_5_HSIOM
#define CYBSP_EZI2C_SDA_IRQ ioss_interrupts_gpio_6_IRQn
#if defined (CY_USING_HAL)
	#define CYBSP_EZI2C_SDA_HAL_PORT_PIN P6_5
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#define CYBSP_BT_UART_RTS_PORT GPIO_PRT9
#define CYBSP_BT_UART_RTS_PORT_NUM 9U
...
#endif
#define CYBSP_BT_UART_RTS_HSIOM ioss_0_port_9_pin_2_HSIOM
#define CYBSP_BT_UART_RTS_IRQ ioss_interrupts_gpio_9_IRQn
#if defined (CY_USING_HAL)
	#define CYBSP_BT_UART_RTS_HAL_PORT_PIN P9_2
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#define CYBSP_BT_UART_CTS_PORT GPIO_PRT9
#define CYBSP_BT_UART_CTS_PORT_NUM 9U
...
#endif
#define CYBSP_BT_UART_CTS_HSIOM ioss_0_port_9_pin_3_HSIOM
#define CYBSP_BT_UART_CTS_IRQ ioss_interrupts_gpio_9_IRQn
#if defined (CY_USING_HAL)
	#define CYBSP_BT_UART_CTS_HAL_PORT_PIN P9_3
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
