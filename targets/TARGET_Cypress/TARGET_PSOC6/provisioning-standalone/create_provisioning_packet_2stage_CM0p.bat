...
python.exe provisioning_packet.py --policy policy_2stage_CM0p.json  --out ./provisioning-packet --cyboot ./prebuild/CypressBootloader_CM0p.jwt --ckey MCUBOOT_CM0P_KEY.json --ckey USERAPP_CM4_KEY.json
