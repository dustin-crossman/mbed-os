...
const cy_stc_gpio_pin_config_t LED5_RGB_G_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_STRONG_IN_OFF,
	.hsiom = LED5_RGB_G_HSIOM,
	.intEdge = CY_GPIO_INTR_DISABLE,
	.intMask = 0UL,
	.vtrip = CY_GPIO_VTRIP_CMOS,
	.slewRate = CY_GPIO_SLEW_FAST,
...
const cy_stc_gpio_pin_config_t LED5_RGB_R_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_STRONG_IN_OFF,
	.hsiom = LED5_RGB_R_HSIOM,
	.intEdge = CY_GPIO_INTR_DISABLE,
	.intMask = 0UL,
	.vtrip = CY_GPIO_VTRIP_CMOS,
	.slewRate = CY_GPIO_SLEW_FAST,
...
const cy_stc_gpio_pin_config_t SW4_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_ANALOG,
	.hsiom = SW4_HSIOM,
...
const cy_stc_gpio_pin_config_t LED5_RGB_B_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_STRONG_IN_OFF,
	.hsiom = LED5_RGB_B_HSIOM,
	.intEdge = CY_GPIO_INTR_DISABLE,
	.intMask = 0UL,
	.vtrip = CY_GPIO_VTRIP_CMOS,
	.slewRate = CY_GPIO_SLEW_FAST,
...
void init_cycfg_pins(void)
{
	...
	Cy_GPIO_Pin_Init(LED5_RGB_G_PORT, LED5_RGB_G_PIN, &LED5_RGB_G_config);
	...
	Cy_GPIO_Pin_Init(CSD_TX_PORT, CSD_TX_PIN, &CSD_TX_config);

	Cy_GPIO_Pin_Init(LED5_RGB_R_PORT, LED5_RGB_R_PIN, &LED5_RGB_R_config);

	Cy_GPIO_Pin_Init(SW4_PORT, SW4_PIN, &SW4_config);
	...
	Cy_GPIO_Pin_Init(CINA_PORT, CINA_PIN, &CINA_config);

	Cy_GPIO_Pin_Init(CINB_PORT, CINB_PIN, &CINB_config);

	Cy_GPIO_Pin_Init(LED5_RGB_B_PORT, LED5_RGB_B_PIN, &LED5_RGB_B_config);

	Cy_GPIO_Pin_Init(CMOD_PORT, CMOD_PIN, &CMOD_config);

	Cy_GPIO_Pin_Init(CSD_BTN0_PORT, CSD_BTN0_PIN, &CSD_BTN0_config);

	Cy_GPIO_Pin_Init(CSD_BTN1_PORT, CSD_BTN1_PIN, &CSD_BTN1_config);

	Cy_GPIO_Pin_Init(CSD_SLD0_PORT, CSD_SLD0_PIN, &CSD_SLD0_config);

	Cy_GPIO_Pin_Init(CSD_SLD1_PORT, CSD_SLD1_PIN, &CSD_SLD1_config);

	Cy_GPIO_Pin_Init(CSD_SLD2_PORT, CSD_SLD2_PIN, &CSD_SLD2_config);

	Cy_GPIO_Pin_Init(CSD_SLD3_PORT, CSD_SLD3_PIN, &CSD_SLD3_config);

	Cy_GPIO_Pin_Init(CSD_SLD4_PORT, CSD_SLD4_PIN, &CSD_SLD4_config);
}
