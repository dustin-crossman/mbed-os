                             ...
                             void *shaBuffers)
{
    ...
    switch (mode)
    {
        ...
        case CY_CRYPTO_MODE_SHA1:
            ...
            hashState->modeHw         = CY_CRYPTO_V1_SHA_CTL_MODE_SHA1;
        ...
        case CY_CRYPTO_MODE_SHA224:
            ...
            hashState->modeHw         = CY_CRYPTO_V1_SHA_CTL_MODE_SHA256;
        ...
        case CY_CRYPTO_MODE_SHA384:
            ...
            hashState->modeHw         = CY_CRYPTO_V1_SHA_CTL_MODE_SHA512;
...
cy_en_crypto_status_t Cy_Crypto_Core_V1_Sha_Start(CRYPTO_Type *base, cy_stc_crypto_sha_state_t *hashState)
{
    ...
    if (hashState != NULL)
    {
        ...
        if (hashState->hashSize != 0U)
        {
            ...
            Cy_Crypto_Core_V1_MemSet(base, hashState->block, 0x00U, hashState->blockSize);
            Cy_Crypto_Core_V1_MemSet(base, hashState->roundMem, 0x00U, hashState->roundMemSize);
