...
typedef struct {
  ...
  __IOM uint32_t ADFT;                          /*!< 0x00000004 Retention */
...
typedef struct {
  ...
  __IOM uint32_t SAR_DPSLP_CTRL[2];             /*!< 0x00000030 Deepsleep control for SARv2 */
   __IM uint32_t RESERVED3[2];
  __IOM uint32_t SAR_HW_TR_SMP_CNT;             /*!< 0x00000040 SAR HW trigger sample control */
  __IOM uint32_t SAR_HW_TR_CTRL;                /*!< 0x00000044 SAR HW trigger override */
  __IOM uint32_t SAR_SIMULT_HW_TR_CTRL;         /*!< 0x00000048 SAR simultaneous trigger control */
  __IOM uint32_t SAR_SIMULT_FW_START_CTRL;      /*!< 0x0000004C SAR simultaneous start control */
  __IOM uint32_t SAR_TR_OUT_CTRL;               /*!< 0x00000050 SAR trigger out control */
...
/* PASS_TIMER.CTRL */
#define PASS_TIMER_V2_CTRL_EN_Pos               31UL
#define PASS_TIMER_V2_CTRL_EN_Msk               0x80000000UL
/* PASS_TIMER.CONFIG */
...
/* PASS_LPOSC.CTRL */
#define PASS_LPOSC_V2_CTRL_DEEPSLEEP_MODE_Pos   0UL
#define PASS_LPOSC_V2_CTRL_DEEPSLEEP_MODE_Msk   0x1UL
#define PASS_LPOSC_V2_CTRL_ENABLE_Pos           31UL
#define PASS_LPOSC_V2_CTRL_ENABLE_Msk           0x80000000UL
/* PASS_LPOSC.ADFT */
...
/* PASS_FIFO.CTRL */
#define PASS_FIFO_V2_CTRL_ENABLE_Pos            31UL
#define PASS_FIFO_V2_CTRL_ENABLE_Msk            0x80000000UL
/* PASS_FIFO.CONFIG */
...
/* PASS.SAR_DPSLP_CTRL */
#define PASS_V2_SAR_DPSLP_CTRL_DEEPSLEEP_ON_Pos 30UL
#define PASS_V2_SAR_DPSLP_CTRL_DEEPSLEEP_ON_Msk 0x40000000UL
