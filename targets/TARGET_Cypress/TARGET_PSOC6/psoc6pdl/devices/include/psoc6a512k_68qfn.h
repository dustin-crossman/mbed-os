/***************************************************************************//**
* \file psoc6a512k_68qfn.h
*
* \brief
* PSOC6A512K_68QFN device header
*
* \note
...
#ifndef _PSOC6A512K_68QFN_H_
#define _PSOC6A512K_68QFN_H_

/**
* \addtogroup group_device PSOC6A512K_68QFN
* \{
*/
...
typedef enum {
  ...
  /* PSOC6A512K_68QFN User Interrupt Numbers */
  ...
  /* PSOC6A512K_68QFN Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* PSOC6A512K_68QFN Peripheral Interrupt Numbers */
...
/* PSOC6A512K_68QFN interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
  ioss_interrupts_gpio_3_IRQn       =   3,      /*!<   3 [DeepSleep] GPIO Port Interrupt #3 */
