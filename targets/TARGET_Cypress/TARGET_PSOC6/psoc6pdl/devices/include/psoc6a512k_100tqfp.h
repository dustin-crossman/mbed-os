/***************************************************************************//**
* \file psoc6a512k_100tqfp.h
*
* \brief
* PSOC6A512K_100TQFP device header
*
* \note
...
#ifndef _PSOC6A512K_100TQFP_H_
#define _PSOC6A512K_100TQFP_H_

/**
* \addtogroup group_device PSOC6A512K_100TQFP
* \{
*/
...
typedef enum {
  ...
  /* PSOC6A512K_100TQFP User Interrupt Numbers */
  ...
  /* PSOC6A512K_100TQFP Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* PSOC6A512K_100TQFP Peripheral Interrupt Numbers */
...
/* PSOC6A512K_100TQFP interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
  ioss_interrupts_gpio_3_IRQn       =   3,      /*!<   3 [DeepSleep] GPIO Port Interrupt #3 */
