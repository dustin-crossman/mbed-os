...
#ifndef _GPIO_PSOC6_02_128_TQFP_H_
#define _GPIO_PSOC6_02_128_TQFP_H_
...
#define P4_2_PIN                        2u
#define P4_2_NUM                        2u
#define P4_2_AMUXSEGMENT                AMUXBUS_NOISY
#define P4_3_PORT                       GPIO_PRT4
#define P4_3_PIN                        3u
#define P4_3_NUM                        3u
#define P4_3_AMUXSEGMENT                AMUXBUS_NOISY
...
typedef enum
{
    ...
    P4_2_TCPWM0_LINE6               =  8,       /* Digital Active - tcpwm[0].line[6]:5 */
    P4_2_TCPWM1_LINE23              =  9,       /* Digital Active - tcpwm[1].line[23]:1 */
    P4_2_CSD_CSD_TX                 = 10,       /* Digital Active - csd.csd_tx:28 */
    P4_2_CSD_CSD_TX_N               = 11,       /* Digital Active - csd.csd_tx_n:28 */
    P4_2_LCD_COM28                  = 12,       /* Digital Deep Sleep - lcd.com[28]:0 */
    P4_2_LCD_SEG28                  = 13,       /* Digital Deep Sleep - lcd.seg[28]:0 */
    P4_2_SCB7_UART_RTS              = 18,       /* Digital Active - scb[7].uart_rts:1 */
    P4_2_SCB7_SPI_CLK               = 20,       /* Digital Active - scb[7].spi_clk:1 */
    ...
    P4_3_TCPWM0_LINE_COMPL6         =  8,       /* Digital Active - tcpwm[0].line_compl[6]:5 */
    P4_3_TCPWM1_LINE_COMPL23        =  9,       /* Digital Active - tcpwm[1].line_compl[23]:1 */
    P4_3_CSD_CSD_TX                 = 10,       /* Digital Active - csd.csd_tx:29 */
    P4_3_CSD_CSD_TX_N               = 11,       /* Digital Active - csd.csd_tx_n:29 */
    P4_3_LCD_COM29                  = 12,       /* Digital Deep Sleep - lcd.com[29]:0 */
    P4_3_LCD_SEG29                  = 13,       /* Digital Deep Sleep - lcd.seg[29]:0 */
    P4_3_SCB7_UART_CTS              = 18,       /* Digital Active - scb[7].uart_cts:1 */
    P4_3_SCB7_SPI_SELECT0           = 20,       /* Digital Active - scb[7].spi_select0:1 */
