...
* Device Support Library (../../../psoc6pdl): 1.4.0.1692
*
********************************************************************************
...
#define ioss_0_port_11_pin_1_DRIVEMODE CY_GPIO_DM_STRONG
#define ioss_0_port_11_pin_1_INIT_DRIVESTATE 0
...
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define ioss_0_port_11_pin_1_HAL_DIR CYHAL_GPIO_DIR_OUTPUT 
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define ioss_0_port_11_pin_1_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_STRONG
#endif //defined (CY_USING_HAL)
