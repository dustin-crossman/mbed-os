...
const PinMap PinMap_UART_RX[] = {
    ...
    //{P4_0, UART_7, CY_PIN_IN_FUNCTION( P4_0_SCB7_UART_RX, PCLK_SCB7_CLOCK)}, //Connected to BT_HOST_WAKE
...
const PinMap PinMap_I2C_SCL[] = {
    ...
    //{P4_0, I2C_7, CY_PIN_OD_FUNCTION( P4_0_SCB7_I2C_SCL, PCLK_SCB7_CLOCK)}, //Connected to BT_HOST_WAKE
...
const PinMap PinMap_SPI_MOSI[] = {
    ...
    //{P4_0, SPI_7, CY_PIN_OUT_FUNCTION( P4_0_SCB7_SPI_MOSI, PCLK_SCB7_CLOCK)}, //Connected to BT_HOST_WAKE
...
const PinMap PinMap_PWM_OUT[] = {
    ...
    //{P4_0, PWM_16b_22, CY_PIN_OUT_FUNCTION(P4_0_TCPWM1_LINE22, PCLK_TCPWM1_CLOCKS22)}, //Connected to BT_HOST_WAKE
