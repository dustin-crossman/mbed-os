...
const PinMap PinMap_UART_RX[] = {
    ...
    {P2_0, UART_1, CY_PIN_IN_FUNCTION(P2_0_SCB1_UART_RX)},
    {P2_4, UART_9, CY_PIN_IN_FUNCTION(P2_4_SCB9_UART_RX)},
    {P3_0, UART_2, CY_PIN_IN_FUNCTION(P3_0_SCB2_UART_RX)},
    {P4_0, UART_7, CY_PIN_IN_FUNCTION(P4_0_SCB7_UART_RX)},
    {P5_0, UART_5, CY_PIN_IN_FUNCTION(P5_0_SCB5_UART_RX)},
    {P5_4, UART_10, CY_PIN_IN_FUNCTION(P5_4_SCB10_UART_RX)},
    ...
    {P8_4, UART_11, CY_PIN_IN_FUNCTION(P8_4_SCB11_UART_RX)},
    ...
    {P13_4, UART_12, CY_PIN_IN_FUNCTION(P13_4_SCB12_UART_RX)},
    {NC,    NC,     0}
};
const PinMap PinMap_UART_TX[] = {
    {P0_3, UART_0, CY_PIN_OUT_FUNCTION(P0_3_SCB0_UART_TX)},
    {P1_1, UART_7, CY_PIN_OUT_FUNCTION(P1_1_SCB7_UART_TX)},
    {P2_1, UART_1, CY_PIN_OUT_FUNCTION(P2_1_SCB1_UART_TX)},
    {P2_5, UART_9, CY_PIN_OUT_FUNCTION(P2_5_SCB9_UART_TX)},
    {P3_1, UART_2, CY_PIN_OUT_FUNCTION(P3_1_SCB2_UART_TX)},
    {P4_1, UART_7, CY_PIN_OUT_FUNCTION(P4_1_SCB7_UART_TX)},
    {P5_1, UART_5, CY_PIN_OUT_FUNCTION(P5_1_SCB5_UART_TX)},
    {P5_5, UART_10, CY_PIN_OUT_FUNCTION(P5_5_SCB10_UART_TX)},
    ...
    {P8_5, UART_11, CY_PIN_OUT_FUNCTION(P8_5_SCB11_UART_TX)},
    ...
    {P13_5, UART_12, CY_PIN_OUT_FUNCTION(P13_5_SCB12_UART_TX)},
    {NC,    NC,     0}
};
const PinMap PinMap_UART_RTS[] = {
    {P0_4, UART_0, CY_PIN_OUT_FUNCTION(P0_4_SCB0_UART_RTS)},
    {P1_2, UART_7, CY_PIN_OUT_FUNCTION(P1_2_SCB7_UART_RTS)},
    {P2_2, UART_1, CY_PIN_OUT_FUNCTION(P2_2_SCB1_UART_RTS)},
    {P2_6, UART_9, CY_PIN_OUT_FUNCTION(P2_6_SCB9_UART_RTS)},
    {P3_2, UART_2, CY_PIN_OUT_FUNCTION(P3_2_SCB2_UART_RTS)},
    {P5_2, UART_5, CY_PIN_OUT_FUNCTION(P5_2_SCB5_UART_RTS)},
    {P5_6, UART_10, CY_PIN_OUT_FUNCTION(P5_6_SCB10_UART_RTS)},
    ...
    {P8_6, UART_11, CY_PIN_OUT_FUNCTION(P8_6_SCB11_UART_RTS)},
    ...
    {P13_2, UART_6, CY_PIN_OUT_FUNCTION(P13_2_SCB6_UART_RTS)},
    {P13_6, UART_12, CY_PIN_OUT_FUNCTION(P13_6_SCB12_UART_RTS)},
    {NC,    NC,     0}
};
const PinMap PinMap_UART_CTS[] = {
    {P0_5, UART_0, CY_PIN_IN_FUNCTION(P0_5_SCB0_UART_CTS)},
    {P1_3, UART_7, CY_PIN_IN_FUNCTION(P1_3_SCB7_UART_CTS)},
    {P2_3, UART_1, CY_PIN_IN_FUNCTION(P2_3_SCB1_UART_CTS)},
    {P2_7, UART_9, CY_PIN_IN_FUNCTION(P2_7_SCB9_UART_CTS)},
    {P3_3, UART_2, CY_PIN_IN_FUNCTION(P3_3_SCB2_UART_CTS)},
    {P5_3, UART_5, CY_PIN_IN_FUNCTION(P5_3_SCB5_UART_CTS)},
    {P5_7, UART_10, CY_PIN_IN_FUNCTION(P5_7_SCB10_UART_CTS)},
    ...
    {P8_7, UART_11, CY_PIN_IN_FUNCTION(P8_7_SCB11_UART_CTS)},
    ...
    {P13_3, UART_6, CY_PIN_IN_FUNCTION(P13_3_SCB6_UART_CTS)},
    {P13_7, UART_12, CY_PIN_IN_FUNCTION(P13_7_SCB12_UART_CTS)},
    {NC,    NC,     0}
};
#endif // DEVICE_SERIAL
...
const PinMap PinMap_I2C_SCL[] = {
    ...
    {P2_0, I2C_1, CY_PIN_OD_FUNCTION(P2_0_SCB1_I2C_SCL)},
    {P2_4, I2C_9, CY_PIN_OD_FUNCTION(P2_4_SCB9_I2C_SCL)},
    {P3_0, I2C_2, CY_PIN_OD_FUNCTION(P3_0_SCB2_I2C_SCL)},
    {P4_0, I2C_7, CY_PIN_OD_FUNCTION(P4_0_SCB7_I2C_SCL)},
    {P5_0, I2C_5, CY_PIN_OD_FUNCTION(P5_0_SCB5_I2C_SCL)},
    {P5_4, I2C_10, CY_PIN_OD_FUNCTION(P5_4_SCB10_I2C_SCL)},
    ...
    {P8_4, I2C_11, CY_PIN_OD_FUNCTION(P8_4_SCB11_I2C_SCL)},
    ...
    {P13_4, I2C_12, CY_PIN_OD_FUNCTION(P13_4_SCB12_I2C_SCL)},
    {NC,    NC,    0}
};
const PinMap PinMap_I2C_SDA[] = {
    {P0_3, I2C_0, CY_PIN_OD_FUNCTION(P0_3_SCB0_I2C_SDA)},
    {P1_1, I2C_7, CY_PIN_OD_FUNCTION(P1_1_SCB7_I2C_SDA)},
    {P2_1, I2C_1, CY_PIN_OD_FUNCTION(P2_1_SCB1_I2C_SDA)},
    {P2_5, I2C_9, CY_PIN_OD_FUNCTION(P2_5_SCB9_I2C_SDA)},
    {P3_1, I2C_2, CY_PIN_OD_FUNCTION(P3_1_SCB2_I2C_SDA)},
    {P4_1, I2C_7, CY_PIN_OD_FUNCTION(P4_1_SCB7_I2C_SDA)},
    {P5_1, I2C_5, CY_PIN_OD_FUNCTION(P5_1_SCB5_I2C_SDA)},
    {P5_5, I2C_10, CY_PIN_OD_FUNCTION(P5_5_SCB10_I2C_SDA)},
    ...
    {P8_5, I2C_11, CY_PIN_OD_FUNCTION(P8_5_SCB11_I2C_SDA)},
    ...
    {P13_5, I2C_12, CY_PIN_OD_FUNCTION(P13_5_SCB12_I2C_SDA)},
    {NC,    NC,    0}
};
#endif // DEVICE_I2C
...
const PinMap PinMap_SPI_MOSI[] = {
    ...
    {P2_0, SPI_1, CY_PIN_OUT_FUNCTION(P2_0_SCB1_SPI_MOSI)},
    {P3_0, SPI_2, CY_PIN_OUT_FUNCTION(P3_0_SCB2_SPI_MOSI)},
    {P4_0, SPI_7, CY_PIN_OUT_FUNCTION(P4_0_SCB7_SPI_MOSI)},
...
const PinMap PinMap_SPI_MISO[] = {
    ...
    {P2_1, SPI_1, CY_PIN_IN_FUNCTION(P2_1_SCB1_SPI_MISO)},
    {P3_1, SPI_2, CY_PIN_IN_FUNCTION(P3_1_SCB2_SPI_MISO)},
    {P4_1, SPI_7, CY_PIN_IN_FUNCTION(P4_1_SCB7_SPI_MISO)},
...
const PinMap PinMap_SPI_SCLK[] = {
    ...
    {P2_2, SPI_1, CY_PIN_OUT_FUNCTION(P2_2_SCB1_SPI_CLK)},
    {P3_2, SPI_2, CY_PIN_OUT_FUNCTION(P3_2_SCB2_SPI_CLK)},
...
const PinMap PinMap_SPI_SSEL[] = {
    ...
    {P2_3, SPI_1, CY_PIN_OUT_FUNCTION(P2_3_SCB1_SPI_SELECT0)},
    {P3_3, SPI_2, CY_PIN_OUT_FUNCTION(P3_3_SCB2_SPI_SELECT0)},
    ...
    {P13_3, SPI_6, CY_PIN_OUT_FUNCTION(P13_3_SCB6_SPI_SELECT0)},
    {NC,    NC,    0}
};
#endif // DEVICE_SPI
...
const PinMap PinMap_PWM_OUT[] = {
    ...
    {P2_0, PWM_16b_15, CY_PIN_OUT_FUNCTION(P2_0_TCPWM1_LINE15)},
    {P2_2, PWM_16b_16, CY_PIN_OUT_FUNCTION(P2_2_TCPWM1_LINE16)},
    {P2_4, PWM_16b_17, CY_PIN_OUT_FUNCTION(P2_4_TCPWM1_LINE17)},
    {P2_6, PWM_16b_18, CY_PIN_OUT_FUNCTION(P2_6_TCPWM1_LINE18)},
    {P3_0, PWM_16b_19, CY_PIN_OUT_FUNCTION(P3_0_TCPWM1_LINE19)},
    {P3_2, PWM_16b_20, CY_PIN_OUT_FUNCTION(P3_2_TCPWM1_LINE20)},
    {P3_4, PWM_16b_21, CY_PIN_OUT_FUNCTION(P3_4_TCPWM1_LINE21)},
    {P4_0, PWM_16b_22, CY_PIN_OUT_FUNCTION(P4_0_TCPWM1_LINE22)},
    ...
    {P13_2, PWM_16b_9, CY_PIN_OUT_FUNCTION(P13_2_TCPWM1_LINE9)},
    {P13_4, PWM_16b_10, CY_PIN_OUT_FUNCTION(P13_4_TCPWM1_LINE10)},
    ...
    {P2_1, PWM_16b_15, CY_PIN_OUT_FUNCTION(P2_1_TCPWM1_LINE_COMPL15)},
    {P2_3, PWM_16b_16, CY_PIN_OUT_FUNCTION(P2_3_TCPWM1_LINE_COMPL16)},
    {P2_5, PWM_16b_17, CY_PIN_OUT_FUNCTION(P2_5_TCPWM1_LINE_COMPL17)},
    {P2_7, PWM_16b_18, CY_PIN_OUT_FUNCTION(P2_7_TCPWM1_LINE_COMPL18)},
    {P3_1, PWM_16b_19, CY_PIN_OUT_FUNCTION(P3_1_TCPWM1_LINE_COMPL19)},
    {P3_3, PWM_16b_20, CY_PIN_OUT_FUNCTION(P3_3_TCPWM1_LINE_COMPL20)},
    {P3_5, PWM_16b_21, CY_PIN_OUT_FUNCTION(P3_5_TCPWM1_LINE_COMPL21)},
    {P4_1, PWM_16b_22, CY_PIN_OUT_FUNCTION(P4_1_TCPWM1_LINE_COMPL22)},
    ...
    {P5_7, PWM_16b_7, CY_PIN_OUT_FUNCTION(P5_7_TCPWM1_LINE_COMPL7)},
    ...
    {P10_7, PWM_16b_2, CY_PIN_OUT_FUNCTION(P10_7_TCPWM1_LINE_COMPL2)},
    ...
    {P13_3, PWM_16b_9, CY_PIN_OUT_FUNCTION(P13_3_TCPWM1_LINE_COMPL9)},
    {P13_5, PWM_16b_10, CY_PIN_OUT_FUNCTION(P13_5_TCPWM1_LINE_COMPL10)},
    ...
    {P2_0, PWM_32b_6, CY_PIN_OUT_FUNCTION(P2_0_TCPWM0_LINE6)},
    {P2_2, PWM_32b_7, CY_PIN_OUT_FUNCTION(P2_2_TCPWM0_LINE7)},
    {P2_4, PWM_32b_0, CY_PIN_OUT_FUNCTION(P2_4_TCPWM0_LINE0)},
    {P2_6, PWM_32b_1, CY_PIN_OUT_FUNCTION(P2_6_TCPWM0_LINE1)},
    {P3_0, PWM_32b_2, CY_PIN_OUT_FUNCTION(P3_0_TCPWM0_LINE2)},
    {P3_2, PWM_32b_3, CY_PIN_OUT_FUNCTION(P3_2_TCPWM0_LINE3)},
    {P3_4, PWM_32b_4, CY_PIN_OUT_FUNCTION(P3_4_TCPWM0_LINE4)},
    {P4_0, PWM_32b_5, CY_PIN_OUT_FUNCTION(P4_0_TCPWM0_LINE5)},
    //{P4_2, PWM_32b_6, CY_PIN_OUT_FUNCTION(P4_2_TCPWM0_LINE6)},
    ...
    {P13_2, PWM_32b_1, CY_PIN_OUT_FUNCTION(P13_2_TCPWM0_LINE1)},
    {P13_4, PWM_32b_2, CY_PIN_OUT_FUNCTION(P13_4_TCPWM0_LINE2)},
    ...
    {P2_1, PWM_32b_6, CY_PIN_OUT_FUNCTION(P2_1_TCPWM0_LINE_COMPL6)},
    {P2_3, PWM_32b_7, CY_PIN_OUT_FUNCTION(P2_3_TCPWM0_LINE_COMPL7)},
    {P2_5, PWM_32b_0, CY_PIN_OUT_FUNCTION(P2_5_TCPWM0_LINE_COMPL0)},
    {P2_7, PWM_32b_1, CY_PIN_OUT_FUNCTION(P2_7_TCPWM0_LINE_COMPL1)},
    {P3_1, PWM_32b_2, CY_PIN_OUT_FUNCTION(P3_1_TCPWM0_LINE_COMPL2)},
    {P3_3, PWM_32b_3, CY_PIN_OUT_FUNCTION(P3_3_TCPWM0_LINE_COMPL3)},
    {P3_5, PWM_32b_4, CY_PIN_OUT_FUNCTION(P3_5_TCPWM0_LINE_COMPL4)},
    {P4_1, PWM_32b_5, CY_PIN_OUT_FUNCTION(P4_1_TCPWM0_LINE_COMPL5)},
    //{P4_3, PWM_32b_6, CY_PIN_OUT_FUNCTION(P4_3_TCPWM0_LINE_COMPL6)},
    ...
    {P5_7, PWM_32b_7, CY_PIN_OUT_FUNCTION(P5_7_TCPWM0_LINE_COMPL7)},
    ...
    {P10_7, PWM_32b_1, CY_PIN_OUT_FUNCTION(P10_7_TCPWM0_LINE_COMPL1)},
    ...
    {P13_3, PWM_32b_1, CY_PIN_OUT_FUNCTION(P13_3_TCPWM0_LINE_COMPL1)},
    {P13_5, PWM_32b_2, CY_PIN_OUT_FUNCTION(P13_5_TCPWM0_LINE_COMPL2)},
...
const PinMap PinMap_ADC[] = {
    {P9_0, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)},  // The SAR ADC Vplus input connects to the P9_0 pin through the AMUXA bus
    {P9_1, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)},  // The SAR ADC Vplus input connects to the P9_1 pin through the AMUXA bus
    {P9_2, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)},  // The SAR ADC Vplus input connects to the P9_2 pin through the AMUXA bus
    {P9_4, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)},  // The SAR ADC Vplus input connects to the P9_4 pin through the AMUXA bus
    {P9_5, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)},  // The SAR ADC Vplus input connects to the P9_5 pin through the AMUXA bus
    {P9_6, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)},  // The SAR ADC Vplus input connects to the P9_6 pin through the AMUXA bus
    {P10_0, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)}, // The SAR ADC Vplus input has the direct connection to the P10_0 pin
    {P10_1, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)}, // The SAR ADC Vplus input has the direct connection to the P10_1 pin
    {P10_2, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)}, // The SAR ADC Vplus input has the direct connection to the P10_2 pin
    {P10_3, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)}, // The SAR ADC Vplus input has the direct connection to the P10_3 pin
    {P10_4, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)}, // The SAR ADC Vplus input has the direct connection to the P10_4 pin
    {P10_5, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)}, // The SAR ADC Vplus input has the direct connection to the P10_5 pin
    {P10_6, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)}, // The SAR ADC Vplus input has the direct connection to the P10_6 pin
    {P10_7, ADC_0, CY_PIN_ANALOG_FUNCTION(HSIOM_SEL_GPIO)}, // The SAR ADC Vplus input has the direct connection to the P10_7 pin
    {NC,    NC,     0}
};
