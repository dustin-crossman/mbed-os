...
}hci_multi_adv_sub_opcode_t;

/* Multi adv command complete callback */
typedef void (CY_multi_adv_cb_t)(hci_multi_adv_sub_opcode_t sub_opcode, uint8_t status);

/* LE Multi advertising parameter class */
class cy_ble_multi_adv_params_t
{
public:
    /* Constructure */
    cy_ble_multi_adv_params_t(ble::advertising_type_t advType = ble::advertising_type_t::NON_CONNECTABLE_UNDIRECTED,
...
public:
     ...
     *
     */
    ble_error_t cy_set_multi_advertisement_params( uint8_t adv_instance, const cy_ble_multi_adv_params_t p_param );
